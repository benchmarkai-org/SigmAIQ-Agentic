...
#new_documents = sigma_llm.compare_releases(old_version='r2024-07-17', new_version='r2024-09-02')

# TODO: create evaluation cases (via Weave) using new_documents


# %% The `create_sigma_vectordb()` method will automatically do all the work for you :) (only run this once)
sigma_llm.create_sigma_vectordb(save=True, version="r2024-07-17")  # Save locally to disk
